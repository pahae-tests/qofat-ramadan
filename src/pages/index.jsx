...
export default function Home({ dark }) {
  ...
  const EMPTY_FORM = { fullName: '', cin: '', phone: '', notes: '', childrenCount: 0, category: '' };
            ...
            <>
              ...
              <div className={`hidden lg:block ${bg} border ${border} rounded-2xl overflow-hidden shadow-sm`}>
                ...
                <div className={`flex items-center justify-between px-4 py-2.5 border-t ${border} ${bg2}`}>
                  <span className={`text-xs ${text3}`}>عرض {sortedPersons.length} سجل</span>
              ...
              <div className="flex flex-col gap-3 lg:hidden">
                    ...
                    <div className="flex items-start justify-between mb-3">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <span className={`text-xs ${text3}`}>#{idx + 1}</span>
                        </div>
                      </div>
                ...
                <p className={`text-center text-xs ${text3} py-2`}>عرض {sortedPersons.length} سجل</p>
              </div>
            </>
          )}
        </main>
